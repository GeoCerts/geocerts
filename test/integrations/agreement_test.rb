    ...
    context 'user agreement' do
      ...
      should 'return a GeoCerts::Agreement' do
        managed_server_request :get, 'https://api-test.geocerts.com/1/products.xml', :response => Responses::Product::All do
          managed_server_request :get, 'https://api-test.geocerts.com/1/products/Q/agreement.xml', :response => Responses::Agreement::Agreement do
      ...
      should 'return an error for an unrecognized product code' do
        managed_server_request :get, 'https://api-test.geocerts.com/1/products/BAD/agreement.xml', :response => Responses::Agreement::UnrecognizedProduct do
